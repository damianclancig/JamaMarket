    ...
    return (
      <div className="container py-12 text-center flex flex-col items-center">
        <div className="relative w-48 h-48 mb-6">
            <Image
                src="/images/jama-correa.webp"
                alt={t('Your_cart_is_empty')}
                fill
            ...
            <Card>
                <CardContent className="p-0">
                    ...
                    {cart.items.map(item => {
                        ...
                        return (
                            <div key={itemKey} className="flex flex-col md:flex-row items-start md:items-center p-4 gap-4">
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      <AlertDialogTitle className="flex items-center gap-2">
                        ...
                        {t('Complete_Shipping_Address')}
                      </AlertDialogTitle>
                      <AlertDialogDescription>
                        {t('Address_Required_Desc')}
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <div className="max-h-[60vh] overflow-y-auto p-1">
                      <CompleteProfileForm 
                        ...
                        onSuccess={() => {
                          ...
                          toast({ title: t('Address_Saved'), description: t('Proceed_to_Payment_Now')});
