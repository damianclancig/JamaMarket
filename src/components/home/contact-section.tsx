...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="container py-12 md:py-20 relative">
             ...
             <form ref={formRef} action={handleSubmit} className="space-y-4">
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
                  ...
                  <div className="hidden sm:flex items-center justify-center">
                    <div className="bg-primary/5 rounded-full p-2 border border-primary/10 hover:scale-110 transition-transform cursor-default">
                      <Image 
                        src="/images/jama-contacto.webp" 
                        alt="Jama Contact Sticker" 
                        width={100} 
                        height={100} 
