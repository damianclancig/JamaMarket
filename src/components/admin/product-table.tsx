    ...
    <Card>
      <CardContent className="p-0">
                  ...
                  <TableRow key={product.id} className="flex flex-col md:table-row p-4 md:p-0 border-b even:bg-muted/25">
                    ...
                    <TableCell className="hidden md:table-cell text-center">
                      <div className="flex justify-center gap-2">
                        <Button asChild variant="ghost" size="icon" className="hover:bg-primary hover:text-white transition-colors">
                        ...
                        <AlertDialog>
                          <AlertDialogTrigger asChild>
                            <Button variant="ghost" size="icon" className="text-destructive hover:bg-destructive hover:text-white transition-colors" disabled={product.state === 'inactivo' || isDeleting}>
                    ...
                    <TableCell className="p-0 md:hidden" colSpan={8}>
                        ...
                        <div className="grid grid-cols-3 gap-2 text-sm mt-4 text-center">
                            <div className="flex flex-col items-center justify-center">
                                <div className="text-xs text-muted-foreground mb-1">{t('Stock_Featured')}</div>
                             ...
                             <div className="flex flex-col items-center justify-center">
                                <div className="text-xs text-muted-foreground mb-1">{t('State')}</div>
                                <Badge variant={product.state === 'activo' ? 'default' : 'destructive'}>
                                    {t(product.state as 'activo' | 'inactivo' | 'vendido')}
                                </Badge>
                            </div>
                            <div className="flex flex-col items-center justify-center">
                                <div className="text-xs text-muted-foreground mb-1">{t('Price')}</div>
        ...
        {!isLoading && products.length === 0 && (
             <p className="text-center text-muted-foreground text-sm p-12">{t('No_Products_Found')}</p>
        )}
