        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="phone">{t('Phone_WhatsApp')}</Label>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea id="instructions" name="instructions" placeholder={t('Instructions_Placeholder')} defaultValue={user.address?.instructions} disabled={isPending} />
              </div>
            </div>
          </div>
        </CardContent>
